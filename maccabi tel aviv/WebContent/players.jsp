    ...
    %>				
		<% 
	  		try 
	  		{
				...
				while (oRS.next() )
					{
					    out.print("<table align='center' width='60%' height='200' border='1'>");
				 	    
					         out.print( "<tr align='center'><td rowspan='4' colspan='3'><img src='"+oRS.getString("picture")+"'width='100%'></td>");
					         out.print( "<td>"+oRS.getString("name")+"</td><td>:שם</td></tr>");
					         out.print( "<tr align='center'><td>"+oRS.getInt("age")+"</td><td>:גיל</td></tr>");
					         out.print( "<tr align='center'><td>"+oRS.getString("position")+"</td><td>:עמדה</td></tr>");					        
					         out.print( "<tr align='center'><td>"+oRS.getInt("numShirt")+"</td><td>:מספר</td></tr>");
