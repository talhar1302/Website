...
%>
		...
		<% 
	  		try 
	  		{
				...
				out.print("<br/><br/><br/>");
				out.print("<form action='doSearchMembers.jsp' method='POST'>");
				out.print("<h1>חפש משתמשים לפי שם פרטי</h1>");
				out.print("<input type='text' name='fname'>");
				out.print("<br/><input type='submit' value='חפש'>");
				out.print("</form>");
				myResultSet.close();
				st.close();
